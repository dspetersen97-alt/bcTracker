"""
Gives a document the public id that appears in every URL that reaches its bytes.

A public id is ten random digits, and it is the only identifier a document is shown
...
class Migration(migrations.Migration):
    dependencies = [
        ("documents", "0002_document_booking"),
    ]
    ...
    operations = [
        ...
        migrations.RunPython(
            partial(_backfill, "documents", "document"),
